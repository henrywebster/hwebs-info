### Who Cares?
I have a bad non-fiction habit. My favorite part after a good chapter is perusing the references. It's a launching pad for places to go next. When they're not there, [I throw a fit.](https://www.goodreads.com/review/show/7262522436?book_show_action=false) As much as ISBN-level material expects them, most content on the internet ignores them. This is a mistake.
...
### What Do I Do?
An excuse for shirking references is the lack of formal standards for certain mediums. YouTube has no form to fill out when a video is uploaded. YouTubers can put them in the description or in the video as text captions. Blogs can use in-text hyperlinks or a more traditional style like MLA. Academic styles have been [adapted to cite YouTube videos and tweets](https://owl.purdue.edu/owl/research_and_citation/mla_style/mla_formatting_and_style_guide/mla_works_cited_electronic_sources.html). With so many options, the challenge is deciding how to reference without the exacting requirements and enforcement of an institution.
